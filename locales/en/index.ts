...
export const en: I18nSchema = {
  ...
  console: {
    ...
    intent_get_block_number: "Get block height",
    intent_chain_id: "Get chain id",
    intent_http_request: "HTTP request",
    intent_load_asset: "Load static asset",
    intent_load_page: "Load page",
    intent_preflight: "CORS preflight",
    intent_rpc_call: "RPC call:",
